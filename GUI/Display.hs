...
-- setpositionForDice x y z =
createVector x y z = Vector3 (x*8000*0.98) ((y*8000*0.98)) z 
createVector2 x y z = Vector3 (x) (y) z 
...
setCubeAtPosition (Quadrup a x y z) = preservingMatrix $ do
      -- color $ Color3 x y z
      translate $ createVector2 x y z
      -- renderString Roman (show a)
      cube (0.015)
      translate $ Vector3 0 0 (0::GLfloat)
