module GeeksLand where
	...
	taxi_edges i = [(i+j-1,i+j,(1,0,0)) | j <- [2..4]++[6..12] ] ++ [(i+4,i+1,(1,0,0)),(i+12,i+5,(1,0,0))]
	...
	getRedEdges = [(a,b) | (a,b,c) <- labEdges geeksland , c == (1,0,0) ] 
	getGreenEdges = [(a,b) | (a,b,c) <- labEdges geeksland , c == (0,1,0) ] 
	getYellowEdges = [(a,b) | (a,b,c) <- labEdges geeksland , c == (0,0,1) ] 
